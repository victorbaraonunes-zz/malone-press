...
include(get_template_directory().'/functions/login-things.php');
include(get_template_directory().'/functions/editor-buttons.php');
include(get_template_directory().'/functions/post-type.php');
